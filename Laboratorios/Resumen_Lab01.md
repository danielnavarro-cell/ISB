...
Por último, también nos mencionaron hacer del Markdown que es el lenguaje con el que estructuramos y redactamos la documentación en los archivos `.md`.
...
Esto fue lo que se mostró en la terminal:
...
Luego de escribir dicho comando, podemos verificar que se guardó correctamente:
...
* 🖼️ Utilizar rutas relativas para imágenes almacenadas en GitHub.
