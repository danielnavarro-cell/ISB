# Ploteos para las señales de hipoventilación
...
# a las derivaciones I, II y III en condición de hipoventilación.
...
file_hipo_D1 = [f for f in filenames if 'D1' in f.upper()][0]
file_hipo_D2 = [f for f in filenames if 'D2' in f.upper()][0]
file_hipo_D3 = [f for f in filenames if 'D3' in f.upper()][0]

print("\nArchivos identificados:")
print("Derivación I :", file_hipo_D1)
print("Derivación II:", file_hipo_D2)
print("Derivación III:", file_hipo_D3)
...
# Procesamos las tres derivaciones de hipoventilación.

procesar_ecg(
    file_hipo_D1,
    'ECG en hipoventilación - Derivación I'
)

procesar_ecg(
    file_hipo_D2,
    'ECG en hipoventilación - Derivación II'
)

procesar_ecg(
    file_hipo_D3,
    'ECG en hipoventilación - Derivación III'
)